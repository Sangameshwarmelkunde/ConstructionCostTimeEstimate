...
public class CostAndTimeEstDAO 
{
    ...
    //--------------------------------------1st insertConstructionProject method-------------------------------------------------  
    public boolean insertConstructionProject(ArrayList < ConstructionProject > constProjects) throws ConstructionEstimationException 
    {
        ...
        return recordsAdded;
    }//End 1st insertConstructionProject method

    //--------------------------------------2nd getConstructionProjectsData -------------------------------------------------  
    ...
    //--------------------------------------2nd End getConstructionProjectsData -------------------------------------------------  


}//end class CostAndTimeEstDAO 